...
class ServiceAppbarScreen extends StatefulWidget {
  const ServiceAppbarScreen({super.key});

  @override
  _ServiceAppbarScreenState createState() => _ServiceAppbarScreenState();
}

class _ServiceAppbarScreenState extends State<ServiceAppbarScreen> {
  @override
  void initState() {
    super.initState();
  }
    ...
    return SafeArea(
      child: Scaffold(
          appBar: PreferredSize(
            ...
            child: CommonAppbar(title: 'Beneficiary Services'.tr),
          ),
