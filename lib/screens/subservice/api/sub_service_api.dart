...
class SubServiceApi{
  ...
  static Future<SubServiceModel?> getSubDepartmentData(String id,Map<String, dynamic>? queryParam) async {
    String url=EndPoints.getSubServiceData+id;
    ...
    try {
      ...
      if (response != null && response.statusCode == 200) {
        ...
        try {
          SubServiceModel model = subServiceModelFromJson(responseBody);
          return model;
        } catch (e) {
  ...
  static Future<SaralAuthModel?> getSaralAuthData(String client_id,String headerParameter) async {
